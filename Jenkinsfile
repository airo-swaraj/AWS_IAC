                ...
                withCredentials([
                    ...
                    sh '''
                        ...
                        if [ "$ISSUE_COUNT" -gt 0 ]; then
                            ...
                            echo "No failing issues found in ${TEMPLATE_FILE}"
                        fi
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="stat-card"><h4>Failing Issues</h4><div class="number">${ISSUE_COUNT}</div></div>
            <div class="stat-card"><h4>Critical</h4><div class="number">${CRITICAL_COUNT}</div></div>
            <div class="stat-card"><h4>High</h4><div class="number">${HIGH_COUNT}</div></div>
